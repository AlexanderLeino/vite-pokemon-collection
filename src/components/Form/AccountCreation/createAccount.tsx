  ...
  return (
    <form onSubmit={(e) => handleSubmit(e)}>
      <Flex justifyContent='justify-center' alignItems='items-center' flexDirection='flex-col' borderRadius='rounded-md' boxShadow='shadow-lg'>
        ...
        <Input label='Password' type='string' name={'userName'} onChange={handleChange} />
        <Input label='Email' type='string' name={'password'} onChange={handleChange} />
        <Input label='First Name' type='string' name={'email'} onChange={handleChange} />
        <Input label='Last Name' type='string' name={'firstName'} onChange={handleChange} />
